...
SYSTEM_CONFIGS = [
    ...
    {"system": "inventory", "key": "damaged", "value": "Damaged", "category": "inventory_condition", "description": "Item is damaged and not usable"},
    ...
    {"system": "inventory", "key": "inventory", "value": "Inventory", "category": "audit_logs_entity_type", "description": "Inventory item entity"},
    {"system": "inventory", "key": "inventory_unit", "value": "Inventory Unit", "category": "audit_logs_entity_type", "description": "Inventory unit entity"},
    {"system": "inventory", "key": "inventory_movement", "value": "Inventory Movement", "category": "audit_logs_entity_type", "description": "Inventory movement entity"},
    {"system": "inventory", "key": "borrow_request", "value": "Borrow Request", "category": "audit_logs_entity_type", "description": "Borrow request entity"},
    ...
    {"system": "inventory", "key": "delete", "value": "Delete", "category": "audit_logs_action", "description": "Entity deleted"},
    {"system": "inventory", "key": "approve", "value": "Approve", "category": "audit_logs_action", "description": "Request approved"},
    {"system": "inventory", "key": "reject", "value": "Reject", "category": "audit_logs_action", "description": "Request rejected"},
    {"system": "inventory", "key": "release", "value": "Release", "category": "audit_logs_action", "description": "Items released"},
    {"system": "inventory", "key": "return", "value": "Return", "category": "audit_logs_action", "description": "Items returned"},
    {"system": "inventory", "key": "warehouse_approve", "value": "Warehouse Approve", "category": "audit_logs_action", "description": "Warehouse approval"},
    {"system": "inventory", "key": "warehouse_reject", "value": "Warehouse Reject", "category": "audit_logs_action", "description": "Warehouse rejection"},
