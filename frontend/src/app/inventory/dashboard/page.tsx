    ...
    <div className="w-full h-full max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-4">
          <Link href="/inventory/items" className="px-6 py-2.5 bg-secondary text-secondary-foreground font-semibold rounded-full border border-border hover:bg-secondary/80 transition-all flex items-center gap-2">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="md:col-span-2 p-6 rounded-2xl bg-card border border-border flex flex-col">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link href="/inventory/requests" className="text-sm font-medium text-indigo-400 hover:text-indigo-300">View All</Link>
          </div>
          ...
          <div className="flex-1 space-y-3">
            {loading ? (
              ...
              recent.map((item) => (
                <div key={item.request_id} className="flex items-center justify-between p-4 rounded-xl border border-border/50 bg-background/50 hover:bg-background transition-colors group">
