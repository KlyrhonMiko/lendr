...
const ENTITY_OPTIONS = [
  { key: '', value: 'All Systems' },
  { key: 'user', value: 'User Account' },
  { key: 'role', value: 'Permissions & Roles' },
  { key: 'config', value: 'System Configuration' },
  { key: 'auth', value: 'Security & Session' },
  { key: 'session', value: 'Login & Sessions' },
];
        ...
        <Popover open={entityFilterOpen} onOpenChange={setEntityFilterOpen}>
          ...
          >
            <span className="truncate">
              {ENTITY_OPTIONS.find((e) => e.key === entityFilter)?.value ?? 'All Systems'}
            </span>
