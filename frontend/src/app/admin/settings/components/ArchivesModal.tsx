        ...
        <div className="p-4 border-b border-border/50 bg-muted/5 flex flex-col sm:flex-row items-center gap-4">
          <div className="flex p-1 bg-secondary/50 rounded-xl border border-border/50 w-full sm:w-fit">
            <button
              ...
              className={`flex-1 sm:flex-none px-6 py-2 rounded-lg text-sm font-bold transition-all flex items-center justify-center gap-2 ${activeTab === 'audit' ? 'bg-background text-primary shadow-sm border border-border/50' : 'text-muted-foreground hover:text-foreground'
                }`}
            >
            ...
            <button
              ...
              className={`flex-1 sm:flex-none px-6 py-2 rounded-lg text-sm font-bold transition-all flex items-center justify-center gap-2 ${activeTab === 'borrow' ? 'bg-background text-primary shadow-sm border border-border/50' : 'text-muted-foreground hover:text-foreground'
                }`}
            >
        ...
        {availableTags.length === 0 ? (
          ...
          availableTags.map(tag => (
            <button
              ...
              className={`flex items-center justify-between px-3 py-2 rounded-lg text-xs font-medium transition-all ${selectedTags.includes(tag)
